package com.example.applicationaseel;
...
public class LogInFragment extends Fragment {
    private EditText etEmailLogIn,etPassLogIn,etTextView1;
    ...
    public void onStart() {
        super.onStart();
        etEmailLogIn = getView().findViewById(R.id.btnLogin);
        etTextView1=getView().findViewById(R.id.etTextView1);
